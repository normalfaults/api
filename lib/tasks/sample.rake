namespace :sample do
  ...
  task jenkins: :environment do
    ...
    Approval.create!([
        { staff_id: 4, project_id: 1, approved: true },
        { staff_id: 4, project_id: 2, approved: true },
        { staff_id: 4, project_id: 3, approved: false },
        { staff_id: 4, project_id: 4, approved: true }
      ])
    Cloud.create!([
    ...
    Project.create!([
        { name: "Blog", description: "Project description", cc: "--CC--", budget: 2000.0, staff_id: "--STAFF_ID--", start_date: "2015-02-06", end_date: "2015-11-06", approval: :approved, img: "/images/128x128-wordpress.png", deleted_at: nil, spent: "1800.0", status: 0 },
        { name: "Cloud File Share", description: "Project description", cc: "--CC--", budget: 123654.0, staff_id: "--STAFF_ID--", start_date: "2015-02-06", end_date: "2015-11-06", approval: :approved, img: "/images/cloud-checkmark-128.png", deleted_at: nil, spent: "0.0", status: 0 },
        { name: "Project 1", description: "Project description", cc: "--CC--", budget: 123654.0, staff_id: "--STAFF_ID--", start_date: "2015-02-06", end_date: "2015-11-06", approval: :undecided, img: "/images/documentation.png", deleted_at: nil, spent: "0.0", status: 0 },
        { name: "Mobile App API", description: "Project description", cc: "--CC--", budget: 3000.0, staff_id: "--STAFF_ID--", start_date: "2015-02-06", end_date: "2015-11-06", approval: :approved, img: "/images/icon-mobile-orange.png", deleted_at: nil, spent: "2000.0", status: 0 }
      ])
    StaffProject.create!([
