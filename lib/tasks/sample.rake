namespace :sample do
  ...
  task demo: :environment do
    ...
    OrderItem.create!([
        { id: 9, order_id: 3, cloud_id: 1, :product => Product.where(id: 2).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 4).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "54048bdc-3cab-4e71-85ca-3b50a3879a31", setup_price: "2.99", hourly_price: "0.0025", monthly_price: "0.075", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 8, order_id: 2, cloud_id: 1, :product => Product.where(id: 5).first, service_id: nil, provision_status: 2, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "4f249639-17ca-493d-8548-9b0728bfc99b", setup_price: "1.99", hourly_price: "0.004", monthly_price: "0.1", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 4, order_id: 1, cloud_id: 1, :product => Product.where(id: 10).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 2).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "0c01b271-fcc6-4fdd-9dab-21f3f2f44e59", setup_price: "0.99", hourly_price: "0.01", monthly_price: "0.05", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 10, order_id: 3, cloud_id: 1, :product => Product.where(id: 2).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 4).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "e8e488c2-ca19-4d6f-aaf1-42d28050904d", setup_price: "2.99", hourly_price: "0.0025", monthly_price: "0.075", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 12, order_id: 3, cloud_id: 1, :product => Product.where(id: 10).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 4).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "ee0164e6-89b7-451f-8351-8fd3d52d4eee", setup_price: "0.99", hourly_price: "0.001", monthly_price: "0.05", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 1, order_id: 1, cloud_id: 1, :product => Product.where(id: 1).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 2).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "422d7851-23ad-4525-b4e9-fad1ad0ce797", setup_price: "1.99", hourly_price: "0.05", monthly_price: "0.05", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 13, order_id: 3, cloud_id: 1, :product => Product.where(id: 11).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 4).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "4d5fc121-9ff6-4464-9529-d279a6b9ac41", setup_price: "0.99", hourly_price: "0.001", monthly_price: "0.05", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 5, order_id: 2, cloud_id: 1, :product => Product.where(id: 2).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "020d8618-e2b2-4a3f-9390-a086d4fdc84a", setup_price: "2.99", hourly_price: "0.0025", monthly_price: "0.075", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 6, order_id: 2, cloud_id: 1, :product => Product.where(id: 2).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "152a5fb2-708c-412c-9187-3030d07089fd", setup_price: "2.99", hourly_price: "0.0025", monthly_price: "0.075", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 11, order_id: 3, cloud_id: 1, :product => Product.where(id: 7).first, service_id: nil, provision_status: 2, deleted_at: nil, :project => Project.where(id: 4).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "8402db1c-b0ca-43b0-9e65-d442be7683ed", setup_price: "3.99", hourly_price: "0.009", monthly_price: "0.5", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 15, order_id: 4, cloud_id: 1, :product => Product.where(id: 4).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: 3306, miq_id: nil, hostname: nil, uuid: "a9e59602-36bf-430f-be92-14f329a99c4a", setup_price: "1.0", hourly_price: "1.0", monthly_price: "1.0", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 2, order_id: 1, cloud_id: 1, :product => Product.where(id: 1).first, service_id: nil, provision_status: 0, deleted_at: nil, :project => Project.where(id: 2).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "7ee39a34-8fb2-4cf4-979a-9ae4d480b6e6", setup_price: "1.99", hourly_price: "0.05", monthly_price: "0.05", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 3, order_id: 1, cloud_id: 1, :product => Product.where(id: 6).first, service_id: nil, provision_status: 1, deleted_at: nil, :project => Project.where(id: 2).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "69ea7d91-e7bb-4854-9ff2-bcd167fe6a71", setup_price: "2.99", hourly_price: "0.09", monthly_price: "0.25", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 17, order_id: 5, cloud_id: 1, :product => Product.where(id: 5).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 2).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "4b0185f0-c309-4a1a-b3be-c9c0438b945d", setup_price: "1.99", hourly_price: "0.004", monthly_price: "0.1", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 18, order_id: 6, cloud_id: 1, :product => Product.where(id: 1).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 4).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "5a459228-b301-42e1-a121-e927cfbfca54", setup_price: "1.99", hourly_price: "0.001", monthly_price: "0.05", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 19, order_id: 7, cloud_id: 1, :product => Product.where(id: 16).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "ce160133-9e2c-4766-923c-d237659de8e6", setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 20, order_id: 8, cloud_id: 1, :product => Product.where(id: 18).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "44642c1d-2fb9-41d8-9acf-d57e87da61fd", setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
        { id: 21, order_id: 9, cloud_id: 2, :product => Product.where(id: 34).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 3).first, host: nil, port: nil, miq_id: nil, hostname: nil, uuid: "add8e14e-6ac2-4476-a9f5-84c6b351a716", setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0", payload_to_miq: nil, payload_reply_from_miq: nil, payload_response_from_miq: nil, latest_alert_id: nil},
    ])
